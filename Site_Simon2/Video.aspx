<%@ Page Title="Video" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Video.aspx.vb" Inherits="Site_Simon2.Video" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" style="height:400px;margin-top: 50px;">
          <div class="row">
              <p class="col-12" style="font-size: x-large">
                  Voici mes videos !!!
                  <table >
                      <tr>
                          <td>
              ...
              <p class="col-12" style="font-size: medium">
                  &nbsp;</p>
